 ...
 * Skeleton loading state for the Dashboard Home page.
 * Mirrors the full dashboard layout (header, stats grid, charts)
 * using Skeleton components from the UI library.
 */
  ...
  return (
    <div className="w-full p-3 md:p-4">
      <div className="max-w-625 mx-auto space-y-4 md:space-y-6">
        {/* Header skeleton: title, subtitle, action buttons, and range selector */}
        ...
        {/* Bottom charts skeleton: pie chart + bar chart in 2-column grid */}
