...
import type { UpgradePlanModalProps } from "@/types/AdminTypes/PlayerManagementTypes"
      ...
      <DialogContent className="bg-card border-white/10 max-w-md" showCloseButton={false}>
        <DialogHeader className="items-center text-center">
          ...
          <DialogTitle className="text-lg font-semibold text-primary">
            {t("playerManagement.upgradeModal.title")}
          </DialogTitle>
        ...
        <DialogFooter className="flex-row gap-3 sm:gap-3">
          ...
          >
            {t("playerManagement.upgradeModal.confirm")}
          </button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
