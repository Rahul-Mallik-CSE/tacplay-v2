...
import type { PlayerActionDropdownProps } from "@/types/AdminTypes/PlayerManagementTypes"
...
export default function PlayerActionDropdown({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-1 w-44 bg-card border border-white/10 rounded-lg shadow-lg z-50 py-1">
          <button
            onClick={(e) => {
              e.stopPropagation()
          ...
          >
            ...
            {t("playerManagement.actions.viewDetails")}
          </button>
        </div>
      )}
    </div>
